...
Current surface: ``validate``. The compile (LLM extraction), approve,
export-gate, and run commands build on top of this validator.
...
def validate(
    ...
    if transcript_path is None:
        transcript_path = contract.parent / loaded.metadata.transcript
    ...
    try:
        parsed_transcript: Transcript = parse_transcript(transcript_path)
